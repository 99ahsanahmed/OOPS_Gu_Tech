...
public:
    course(string cr, string teacher, string course_name) : cr(cr), teacher(teacher), course_name(course_name), students_count(0), students{student("ahsan", 123), student("shamoeel", 124)} {};
